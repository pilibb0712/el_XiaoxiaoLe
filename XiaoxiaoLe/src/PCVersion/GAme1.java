...
import java.util.ArrayList;
			...
			public class GAme1 {
				 ...
				 static void playButtonsound(){
					 try{
							URL musicURL=GAme1.class.getResource("buttonsound.wav");
				...
				public static void GAME1(JPanel panel2,JTextField step,JTextField score,JButton exit,Object current){
				  icons[0]=new ImageIcon(GAme1.class.getResource("icon1.jpg"));
				  icons[1]=new ImageIcon(GAme1.class.getResource("icon2.jpg"));
				  icons[2]=new ImageIcon(GAme1.class.getResource("icon3.jpg"));
				  icons[3]=new ImageIcon(GAme1.class.getResource("icon4.jpg"));
				  icons[4]=new ImageIcon(GAme1.class.getResource("icon5.jpg"));
				  rollover[0]=new ImageIcon(GAme1.class.getResource("icon1rollover.jpg"));
				  rollover[1]=new ImageIcon(GAme1.class.getResource("icon2rollover.jpg"));
				  rollover[2]=new ImageIcon(GAme1.class.getResource("icon3rollover.jpg"));
				  rollover[3]=new ImageIcon(GAme1.class.getResource("icon4rollover.jpg"));
				  rollover[4]=new ImageIcon(GAme1.class.getResource("icon5rollover.jpg"));
